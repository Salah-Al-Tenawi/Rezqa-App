...
import 'package:freelanc/features/client/addofferclient/controller/ClientAddOfferController.dart';
import 'package:get/get.dart';
import 'package:file_selector/file_selector.dart';
import 'package:dotted_border/dotted_border.dart';

class AddClintOfferscreen extends StatelessWidget {
  final AddClintOfferController controller =
      Get.put(AddClintOfferController());

  final TextEditingController titleController = TextEditingController();
  final TextEditingController descriptionController = TextEditingController();
  final TextEditingController daysController = TextEditingController();

  AddClintOfferscreen({super.key});
  ...
  Widget buildSubCategoryDropdown() {
    return Obx(() {
      if (controller.categories.isEmpty) {
        return Text('جاري تحميل التصنيفات...');
      }
      return DropdownButton<int>(
        hint: Text('اختر فئة فرعية'),
      ...
      children: [
        Obx(() {
          ...
          return Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              if (!hasMinSkills) SizedBox(height: 8),
              ElevatedButton(
